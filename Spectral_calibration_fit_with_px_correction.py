...
class BatchCalibration:
    ...
    def calibrate_array(self):
        ...
        description = "back: " + str(path_background) + "RZP-structure:___" + str(rzp_structure_name) + 'Roi:' + str(roi_list)
        for x in self.file_list:
...
path_background = "data/dark_100ms"
name_background = path_background
path_picture = "data/R_S3_Fe_100ms"
...
calibration_file = "calibration_files/20220511_fit_positions.txt"
calibration_xxx = basic_file_app.load_1d_array(calibration_file, 1,1)
cal_path = "20220511_Fe_calibrated"
