...
reference[:, 0] = Basic_File_App.load_1d_array("20210205_reference.txt",1,3)
reference[:, 1] = Basic_File_App.load_1d_array("20210205_reference.txt",2,3)

emission_lines = np.zeros([15, 2])
emission_lines[:, 0] = Basic_File_App.load_1d_array("Fe_lines_S2.txt",1,3)
