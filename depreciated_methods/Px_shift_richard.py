...
def correlation_spectra(spectrum_start,spectrum,spectrum_part1, spectrum_part_2,corr_spectrum_start, corr_corr = False):
    '''
...
spectrum_start = gaus1d(1,xc,FWHM,x) # start spectrum
spectrum = gaus1d(1,xc_spectrum,FWHM,x) # other spectrum
...
spectrum_correlation = correlation_spectra(spectrum_start,spectrum,spectrum_part1, spectrum_part_2,corr_spectrum_start, corr_corr)
